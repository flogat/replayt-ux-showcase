...
- Playbook: Handovers pass checklist (<1 dev-day) using **[`docs/playbook/README.md`](playbook/README.md)** (tokens, timeline/overlay anatomy, printable **[`handoff-checklist.md`](playbook/handoff-checklist.md)**), alongside **[`docs/a11y/keyboard-model.md`](a11y/keyboard-model.md)** for keyboard/focus. **Figma**-side alignment and interim token export: **[`docs/design-kit/README.md`](design-kit/README.md)** (**F1–F8**).
...
**Source of truth:** [`docs/examples/PATTERNS.md`](examples/PATTERNS.md) — pattern IDs (**P-01**–**P-05**, **P-09**, **P-10**, and **P-11** vanilla **Shipped**; **P-06**–**P-08** framework rows, …), filenames, status (**Shipped** / **Spec only** / **Planned**), and per-pattern acceptance criteria.

| Metric | Target | Current (update when patterns ship) |
| ------ | ------ | ------------------------------------- |
| Distinct vanilla patterns in `docs/examples/` | ≥ 5 | **8** shipped (**P-01**–**P-05**, **P-09**–**P-11** — [`PATTERNS.md`](examples/PATTERNS.md)), including **`fixture-replay.html`** (**P-05**: deterministic offline fixture for reviewers / **LLM** harnesses), **`event-overlay.html`** [**P-09**](examples/PATTERNS.md#p-09--event-overlay-lane-scrub-hover-tooltips-keyboard) (event overlay lane + scrub-linked callouts), **`click-heatmap-canvas.html`** [**P-10**](examples/PATTERNS.md#p-10--click-heatmap-on-static-canvas-session-click-coordinates) (binned **click** **`x`/`y`** heatmap on a viewport-sized canvas; distinct from **P-09**), and **`basic-player-tailwind.html`** [**P-11**](examples/PATTERNS.md#p-11--basic-player-chrome-tailwind-css-layout-parity) (**Tailwind** layout parity with **P-01**). |
