...
| **`.github/workflows/ci.yml`** — **`examples-playwright-smoke`** job (or edits to that job) | [Static HTML examples: browser smoke (Playwright)](docs/DESIGN_PRINCIPLES.md#static-html-examples-browser-smoke-playwright); **`docs/compat.md`** [CI exercise row inventory](docs/compat.md#ci-exercise-row-inventory) (**EX-PLAYWRIGHT-SMOKE** in the **same** change set) |
