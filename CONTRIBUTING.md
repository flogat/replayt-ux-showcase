...
| **`.github/workflows/ci.yml`** — optional **Playwright** / static HTML smoke job (when added) | [Static HTML examples: browser smoke (Playwright)](docs/DESIGN_PRINCIPLES.md#static-html-examples-browser-smoke-playwright); **`docs/compat.md`** [CI exercise row inventory](docs/compat.md#ci-exercise-row-inventory) (**EX-*** row in the **same** change set) |
