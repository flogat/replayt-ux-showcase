...
| `docs/examples/event-overlay.html` | **P-09** event overlay lane (scrub-linked callouts, hover + keyboard) — **Spec only** until shipped (**[`docs/examples/PATTERNS.md`](docs/examples/PATTERNS.md#p-09--event-overlay-lane-scrub-hover-tooltips-keyboard)**) |
