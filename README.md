...
| `docs/examples/basic-player-tailwind.html` | **P-11** **Tailwind** layout twin of **P-01** + documented **`content` / `@source`** paths — **Spec only** (planned — [**`docs/examples/PATTERNS.md`**](docs/examples/PATTERNS.md#p-11--basic-player-chrome-tailwind-css-layout-parity)) |
